...
/**
 * This class will be used to wrap all webdriver functions in methods. All Page Object classes will then use
 * these methods instead of making direct webdriver calls on their initialised elements. This class should not be used
 * in any stepDefinition classes but only called through Page Object classes. All new Webdriver functionality should be
 * added here
 */
